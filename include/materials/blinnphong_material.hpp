...
public:
    ...
    BlinnPhongMaterial(const RGBColor& a, const RGBColor& d, const RGBColor& s, float g, RGBColor mirror = {0,0,0})
    ...
    RGBColor scatter(const vec3& wo, const vec3& wi, const vec3& n) const override {
        ...
        RGBColor diffuse = kd_ * cos_theta;
        ...
        RGBColor specular = ks_ * std::pow(cos_alpha, glossiness_);
