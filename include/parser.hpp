...
private:
  ...
  std::unordered_map<
      ...
      conversor_{
          ...
          {"ambient", convert<point3, float, 3>},
          {"diffuse", convert<point3, float, 3>},
          {"specular", convert<point3, float, 3>},
          {"I", convert<point3, float, 3>},
          {"scale", convert<point3, float, 3>},
